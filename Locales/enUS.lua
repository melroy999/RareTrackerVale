...
local L = LibStub("AceLocale-3.0"):NewLocale("RareTrackerVale", "enUS", true)
if not L then return end

L["seen at"] = "seen at"
L["<RTV> %s has died"] = "<RTV> %s has died"
...
L["<RTV> Resetting current rare timers and requesting up-to-date data."] = "<RTV> Resetting current rare timers and requesting up-to-date data."
L["<RTV> Please target a non-player entity prior to resetting, such that the addon can determine the current shard id."] = "<RTV> Please target a non-player entity prior to resetting, such that the addon can determine the current shard id."
L["<RTV> The reset button is on cooldown. Please note that a reset is not needed to receive new timers. If it is your intention to reset the data, please do a /reload and click the reset button again."] = "<RTV> The reset button is on cooldown. Please note that a reset is not needed to receive new timers. If it is your intention to reset the data, please do a /reload and click the reset button again."
...
L["<RTV> Favorites cannot be hidden."] = "<RTV> Favorites cannot be hidden."
...
L["Shard ID: "] = "Shard ID: "
L["<RTV> %s (%s%%) seen at ~(%.2f, %.2f)"] = "<RTV> %s (%s%%) seen at ~(%.2f, %.2f)"
L["<RTV> %s (%s%%) seen at ~(N/A)"] = "<RTV> %s (%s%%) seen at ~(N/A)"
L["<RTV> %s was last seen ~%s minutes ago"] = "<RTV> %s was last seen ~%s minutes ago"
L["<RTV> %s seen alive, vignette at ~(%.2f, %.2f)"] = "<RTV> %s seen alive, vignette at ~(%.2f, %.2f)"
L["<RTV> %s seen alive (combat log)"] = "<RTV> %s seen alive (combat log)"
L["Left-click: hide/show RTV"] = "Left-click: hide/show RTV"
L["Right-click: show options"] = "Right-click: show options"
L["<RTV> Moving to shard "] = "<RTV> Moving to shard "
L["<RTV> Removing cached data for shard "] = "<RTV> Removing cached data for shard "
L["<RTV> Restoring data from previous session in shard "] = "<RTV> Restoring data from previous session in shard "
L["<RTV> Requesting rare kill data for shard "] = "<RTV> Requesting rare kill data for shard "
L["<RTV> Your version or RareTrackerVale is outdated. Please update to the most recent version at the earliest convenience."] = "<RTV> Your version or RareTrackerVale is outdated. Please update to the most recent version at the earliest convenience."
L["<RTV> Failed to register AddonPrefix 'RTV'. RTV will not function properly."] = "<RTV> Failed to register AddonPrefix 'RTV'. RTV will not function properly."